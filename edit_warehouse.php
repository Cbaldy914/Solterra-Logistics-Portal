...
<script>
let currentStep = 1;
const stepNames = {1: 'Basic Info', 2: 'Location', 3: 'Costs'};
...
(function() {
    ...
    const header = document.querySelector('.edit-warehouse-header');
    let wrapperTop = 0;
    let wrapperHeight = 0;
...
// Legacy accordion toggle (kept for compatibility)
