...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Admin always creates solterra-managed carriers; global_admin has toggle (defaults checked)
        if ($role === 'admin') {
            $is_solterra_managed = 1;
        } elseif ($role === 'global_admin') {
            $is_solterra_managed = isset($_POST['is_solterra_managed']) ? 1 : 0;
        } else {
            $is_solterra_managed = 0;
        }
        ...
        $carrier_account_id = in_array($role, ['admin', 'global_admin'], true) ? null : $account_id;
        $stmt = $conn->prepare("
        ...
        <div class="form-section">
            ...
            <div class="form-section-body">
                ...
                <div class="form-row">
                    ...
                    <?php $solterra_managed_checked = ($_SERVER['REQUEST_METHOD'] === 'POST') ? !empty($_POST['is_solterra_managed']) : true; ?>
                    <div class="form-group">
                        <div class="checkbox-container">
                            <input type="checkbox" id="is_solterra_managed" name="is_solterra_managed" <?php echo $solterra_managed_checked ? 'checked' : ''; ?>>
