...
<head>
    ...
    <title>Bills of Lading - <?php echo htmlspecialchars($project_name); ?></title>
...
<main>
    ...
    <div class="documents-container">
        ...
        <div class="empty-state">
            ...
            <h3>No Bills of Lading Found</h3>
                <p>Bills of lading documents will appear here once uploaded for this project.</p>
                <?php if ($can_upload): ?>
                    <button class="upload-button" onclick="openUploadModal()">
                        <i class="fas fa-plus"></i>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="uploadForm">
                    ...
                    <input type="hidden" name="document_type" value="bills_of_lading">
...
window.uploadDocument = async function() {
    ...
    try {
        for (let i = 0; i < files.length; i++) {
            ...
            formData.append('document_type', 'bills_of_lading');
        ...
        closeUploadModal();
        loadDocuments('bills_of_lading'); // Reload documents
