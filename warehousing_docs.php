...
<head>
    ...
    <title>Warehousing - <?php echo htmlspecialchars($project_name); ?></title>
    ...
    <div class="documents-container">
        ...
        <div class="empty-state">
            <div class="empty-state-icon">🏭</div>
                <h3>Loading Warehousing Documents...</h3>
    ...
    <div id="uploadModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2>Upload Warehousing Document</h2>
            ...
            <div class="modal-body">
                <form id="uploadForm" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="document_type" value="warehousing">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadDocuments() {
        fetch(`get_project_documents.php?project_id=${projectId}&document_type=warehousing`)
    ...
    function displayDocuments(documents) {
        ...
        <div class="empty-state">
            <div class="empty-state-icon">🏭</div>
            <h3>No Warehousing Documents Found</h3>
            <p>Warehousing documents will appear here once uploaded for this project.</p>
    ...
    window.uploadDocument = async function() {
        ...
        try {
            for (let i = 0; i < files.length; i++) {
                ...
                formData.append('document_type', 'warehousing');
