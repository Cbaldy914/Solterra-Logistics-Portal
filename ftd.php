...
<head>
    ...
    <title>Flash Test Data - <?php echo htmlspecialchars($project_name); ?></title>
    ...
    <div class="documents-container">
        ...
        <div id="documents-list">
            <div class="empty-state">
                ...
                <h3>No Flash Test Data Found</h3>
                <p>Flash test data documents will appear here once uploaded for this project.</p>
                <?php if ($can_upload): ?>
                    <button class="upload-button" onclick="openUploadModal()">
                        <i class="fas fa-plus"></i>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="uploadForm">
                    ...
                    <input type="hidden" name="document_type" value="ftd">
...
window.uploadDocument = async function() {
    ...
    try {
        for (let i = 0; i < files.length; i++) {
            ...
            formData.append('document_type', 'ftd');
        ...
        closeUploadModal();
        loadDocuments('ftd'); // Reload documents
